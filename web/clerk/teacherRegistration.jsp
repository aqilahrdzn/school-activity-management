<%-- 
    ...
    Created on : May 11, 2025, 9:52:36 PM
    Author     : Lenovo
--%>
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" action="../TeacherRegisterServlet" method="post">
                                            ...
                                            <!-- Guru Kelas Section (Hidden unless role is Teacher) -->
                                            <div id="guruKelasSection" style="display: none;">
                                                <div class="form-group">
                                                    <label>Guru Kelas?</label><br>
                        ...
                        <script>
                            function toggleGuruKelasSection() {
                                const role = document.getElementById("role").value;
                                const guruKelasSection = document.getElementById("guruKelasSection");

                                if (role === "Teacher") {
                                    guruKelasSection.style.display = "block";
                                } else {
                                    guruKelasSection.style.display = "none";
                                    // Reset radio buttons and class dropdown
                                    document.querySelectorAll('input[name="is_guru_kelas"]').forEach(r => r.checked = false);
                                    document.getElementById("classDropdown").style.display = "none";
                                }
                            }

                            function toggleClassDropdown() {
                                const selected = document.querySelector('input[name="is_guru_kelas"]:checked');
                                ...
                                if (selected && selected.value === "Yes") {
                                    ...
                                    document.getElementById("kelas").value = ""; // Reset class
                                }
                            }
                        </script>
