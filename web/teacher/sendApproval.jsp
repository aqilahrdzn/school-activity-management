<%-- 
    Document   : sendApproval
    Created on : May 25, 2025, 2:22:26 PM
    Author     : Lenovo
--%>
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        ...
                        <%
                            ...
                            String title = "", description = "", startTime = "", suratPengesahan = "";

                            try (Connection conn = DBConfig.getConnection()) {
                                String sql = "SELECT title, description, start_time, surat_pengesahan FROM events WHERE id = ?";
                                ...
                                if (rs.next()) {
                                    ...
                                    suratPengesahan = rs.getString("surat_pengesahan");
                                }
                            } catch (SQLException e) {
                                out.println("Database error: " + e.getMessage());
                            }

                            boolean alreadyUploaded = suratPengesahan != null && !suratPengesahan.trim().isEmpty();
                        %>
                            ...
                            <div class="col-md-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <% } else {%>
                                        <form class="forms-sample" action="<%= request.getContextPath()%>/UploadSuratServlet" method="post" enctype="multipart/form-data">
